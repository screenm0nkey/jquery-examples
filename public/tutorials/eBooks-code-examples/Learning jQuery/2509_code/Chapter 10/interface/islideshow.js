...
jQuery.islideshow = {
	...
	go : function(o)
	{
		...
		if (o && o.constructor == Object) {
			...
			if (images.size() > 0) {
				...
				//slideshow.ss.holder.html('<img src="../../../../../Learning jQuery/2509_code/Chapter 10/interface/' + slideshow.ss.images[slide-1].src + '" />');
				if (slideshow.ss.slideCaption) {
	...
	showImage : function()
	{
		...
		//slideshow.ss.holder.html('<img src="../../../../../Learning jQuery/2509_code/Chapter 10/interface/' + slideshow.ss.images[slideshow.ss.currentslide - 1].src + '" />');
	...
	display : function ()
	{
		...
		slideshow.ss.holder.css('top', y + 'px').css('left', x + 'px').html('<img src="../../../../../Learning jQuery/2509_code/Chapter 10/interface/' + this.src + '" />');
	...
	build : function(o)
	{
		...
		if (o.loader) {
			container.prepend('<div class="slideshowLoader" style="display: none;"><img src="../../../../../Learning jQuery/2509_code/Chapter 10/interface/' + o.loader + '" /></div>');
