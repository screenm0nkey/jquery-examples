			...
			if (percentInView < 0.99) {
				...
				$container.append(
					jQuery('<div></div>').attr({'className':'jScrollPaneTrack'}).css({'height':settings.scrollbarHeight+'px'}).append(
						jQuery('<div></div>').attr({'className':'jScrollPaneTrackLeft'}).css({'height':settings.scrollbarHeight+'px'}),
						...
						$('<div></div>').attr({'className':'jScrollPaneTrackRight'}).css({'height':settings.scrollbarHeight+'px'})
					)
				);
